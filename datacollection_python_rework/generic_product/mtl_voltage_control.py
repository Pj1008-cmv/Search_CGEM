...
path_file = r"C:\SVSHARE\cmv_client_automation_mtl\python\path_list.json"
##path_file = r"C:\sthi\Fusion\applications.validation.circuit-margin.meteorlake.s.681.ioe-socsouth\python\path_file.json"
PATH_LIST = "path_list"
